...
library(mlogit)
d<-read.csv("CE_R_p5.csv")
data<-mlogit.data(d,choice="choice",shape="wide",varying=7:474,
                  id="id",sep="")

library(reshape)
data<-rename(data,c(pc_pregnant = "p5_pregnant", pc_child = "p5_child", 
                    pc_baby = "p5_baby", pc_protection = "p5_protection", 
                    pc_ownrisk = "p5_ownrisk", pc_duration = "p5_duration", 
                    info_pc_pregnant="info_p5_pregnant", 
                    info_pc_child = "info_p5_child", 
                    info_pc_baby = "info_p5_baby", 
                    info_pc_protection = "info_p5_protection", 
                    info_pc_ownrisk = "info_p5_ownrisk", 
                    info_pc_duration="info_p5_duration"))

set.seed(98457)
save.image("session-main_p5.RData")
draws<-1000

baseline.mxl<-mlogit(choice~price+asc+pregnant+baby + child + protection + 
                     own_risk + duration + info_pregnant + info_child + info_baby + 
                     info_protection + info_ownrisk + info_duration + p5_pregnant + 
                     p5_child + p5_baby + p5_protection + p5_ownrisk + 
                     p5_duration + info_p5_pregnant + info_p5_child + 
                     info_p5_baby + info_p5_protection + info_p5_ownrisk + 
                     info_p5_duration|0,data, rpar=c(asc='n', pregnant ='n', child = 'n', 
                     baby='n', protection='n',own_risk='n', duration='n', info_pregnant='n', 
                     info_child='n', info_baby='n', info_protection='n', info_ownrisk='n', 
                     info_duration='n', p5_pregnant='n', p5_child='n', p5_baby='n', 
                     p5_protection='n', p5_ownrisk='n', p5_duration='n', 
                     info_p5_pregnant='n', info_p5_child='n', info_p5_baby='n',
                     info_p5_protection='n', info_p5_ownrisk='n', info_p5_duration='n'),
...
noschool.mxl<-mlogit(choice~price+asc+pregnant+baby + child + protection + 
                     ...
                     p5_pregnant + p5_child + p5_baby + p5_protection + p5_ownrisk +
                     p5_duration + info_p5_pregnant + info_p5_child + 
                     info_p5_baby + info_p5_protection + info_p5_ownrisk + 
                     info_p5_duration|0,data, rpar=c(asc='n', pregnant ='n', child = 'n', 
                     baby='n', protection='n',own_risk='n', duration='n', info_pregnant='n', 
