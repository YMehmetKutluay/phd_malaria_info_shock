...
library(mlogit)
d<-read.csv("CE_R_p05.csv")
data<-mlogit.data(d,choice="choice",shape="wide",varying=7:474,
                  id="id",sep="")
library(reshape)
data<-rename(data,c(pa_pregnant = "p05_pregnant", pa_child = "p05_child", 
                    pa_baby = "p05_baby", pa_protection = "p05_protection", 
                    pa_ownrisk = "p05_ownrisk", pa_duration = "p05_duration", 
                    info_pa_pregnant="info_p05_pregnant", 
                    info_pa_child = "info_p05_child", 
                    info_pa_baby = "info_p05_baby", 
                    info_pa_protection = "info_p05_protection", 
                    info_pa_ownrisk = "info_p05_ownrisk", 
                    info_pa_duration="info_p05_duration"))
set.seed(98457)
save.image("session-main_p05.RData")
draws<-1000

baseline.mxl<-mlogit(choice~price+asc+pregnant+baby + child + protection + 
                     own_risk + duration + info_pregnant + info_child + info_baby + 
                     info_protection + info_ownrisk + info_duration + p05_pregnant + 
                     p05_child + p05_baby + p05_protection + p05_ownrisk + 
                     p05_duration + info_p05_pregnant + info_p05_child + 
                     info_p05_baby + info_p05_protection + info_p05_ownrisk + 
                     info_p05_duration|0,data, rpar=c(asc='n', pregnant ='n', child = 'n', 
                     baby='n', protection='n',own_risk='n', duration='n', info_pregnant='n', 
                     info_child='n', info_baby='n', info_protection='n', info_ownrisk='n', 
                     info_duration='n', p05_pregnant='n', p05_child='n', p05_baby='n', 
                     p05_protection='n', p05_ownrisk='n', p05_duration='n', 
                     info_p05_pregnant='n', info_p05_child='n', info_p05_baby='n',
                     info_p05_protection='n', info_p05_ownrisk='n', info_p05_duration='n'),
...
noschool.mxl<-mlogit(choice~price+asc+pregnant+baby + child + protection + 
                     ...
                     p05_pregnant + p05_child + p05_baby + p05_protection + p05_ownrisk +
                     p05_duration + info_p05_pregnant + info_p05_child + 
                     info_p05_baby + info_p05_protection + info_p05_ownrisk + 
                     info_p05_duration|0,data, rpar=c(asc='n', pregnant ='n', child = 'n', 
                     baby='n', protection='n',own_risk='n', duration='n', info_pregnant='n', 
