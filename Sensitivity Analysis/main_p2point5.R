...
library(mlogit)
d<-read.csv("CE_R_p2point5.csv")
data<-mlogit.data(d,choice="choice",shape="wide",varying=7:474,
                  id="id",sep="")

library(reshape)
data<-rename(data,c(pb_pregnant = "p2point5_pregnant", pb_child = "p2point5_child", 
                    pb_baby = "p2point5_baby", pb_protection = "p2point5_protection", 
                    pb_ownrisk = "p2point5_ownrisk", pb_duration = "p2point5_duration", 
                    info_pb_pregnant="info_p2point5_pregnant", 
                    info_pb_child = "info_p2point5_child", 
                    info_pb_baby = "info_p2point5_baby", 
                    info_pb_protection = "info_p2point5_protection", 
                    info_pb_ownrisk = "info_p2point5_ownrisk", 
                    info_pb_duration="info_p2point5_duration"))

set.seed(98457)
save.image("session-main_p2point5.RData")
draws<-1000

baseline.mxl<-mlogit(choice~price+asc+pregnant+baby + child + protection + 
                     own_risk + duration + info_pregnant + info_child + info_baby + 
                     info_protection + info_ownrisk + info_duration + p2point5_pregnant + 
                     p2point5_child + p2point5_baby + p2point5_protection + p2point5_ownrisk + 
                     p2point5_duration + info_p2point5_pregnant + info_p2point5_child + 
                     info_p2point5_baby + info_p2point5_protection + info_p2point5_ownrisk + 
                     info_p2point5_duration|0,data, rpar=c(asc='n', pregnant ='n', child = 'n', 
                     baby='n', protection='n',own_risk='n', duration='n', info_pregnant='n', 
                     info_child='n', info_baby='n', info_protection='n', info_ownrisk='n', 
                     info_duration='n', p2point5_pregnant='n', p2point5_child='n', p2point5_baby='n', 
                     p2point5_protection='n', p2point5_ownrisk='n', p2point5_duration='n', 
                     info_p2point5_pregnant='n', info_p2point5_child='n', info_p2point5_baby='n',
                     info_p2point5_protection='n', info_p2point5_ownrisk='n', info_p2point5_duration='n'),
...
noschool.mxl<-mlogit(choice~price+asc+pregnant+baby + child + protection + 
                     ...
                     p2point5_pregnant + p2point5_child + p2point5_baby + p2point5_protection + p2point5_ownrisk +
                     p2point5_duration + info_p2point5_pregnant + info_p2point5_child + 
                     info_p2point5_baby + info_p2point5_protection + info_p2point5_ownrisk + 
                     info_p2point5_duration|0,data, rpar=c(asc='n', pregnant ='n', child = 'n', 
                     baby='n', protection='n',own_risk='n', duration='n', info_pregnant='n', 
